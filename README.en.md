...
npm run test-firefox        # the same 1170 assertions, under Gecko
```
...
| `npm test` | the Playwright harness: 129 scenarios, 1170 assertions |
...
| --- | --- | --- | --- |
| `content.js` | 1057 KB | 404 KB | 3,333 → **2** |
