...
npm run test-firefox        # the same 1165 assertions, under Gecko
```
...
| `npm test` | the Playwright harness: 128 scenarios, 1165 assertions |
...
| --- | --- | --- | --- |
| `content.js` | 1057 KB | 404 KB | 3,329 → **2** |
